...
public:
    ...
    void retranslateUi(QDialog *NetClientUI)
    {
        ...
        label_3->setText(QApplication::translate("NetClientUI", "<html><head><meta name=\"qrichtext\" content=\"1\" /></head><body style=\" white-space: pre-wrap; font-family:MS Shell Dlg; font-weight:400; font-style:normal; text-decoration:none;\"><p style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\"><span style=\" color:#000000;\">Vous devez conna\303\203\302\256tre l'adresse IP du joueur serveur</span></p></body></html>", 0, QApplication::UnicodeUTF8));
