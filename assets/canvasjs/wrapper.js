...
var mouseListeners = new Listeners();
...
function mouseEvent(mouse)
{
    ...
    event.pageX = mouse.x;
    event.pageY = mouse.y;
    mouseListeners.fireEvent("mousedown", event);
}

function addEventListener(name, callback)
{
    mouseListeners.add(new Listener(name, callback));
}
...
var addSign = function(g,s,b,f,z,m,t) {
...
function initialize()
{
     ...
     gooEngine = new Goo({
      ...
      onMouseDown:function(g){
        addSign(g, "g.onMouseDown()", "#3380FF", "white", 1.5, 40, true);
      },
