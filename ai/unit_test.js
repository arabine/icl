...
function RunFakeGame()
{
	...
	// We send cards to each players
	for(var i=0; i<72; i++) {
		var owner = parseInt(this.owners[i]);
		CurrentGame.players[owner].deck.AddOneCard(this.cards[i], owner);
	}
